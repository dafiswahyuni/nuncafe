...
<head>
    ...
    <!-- Vector CSS -->
    <link href="/mytemp/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- simplebar CSS-->
    <link href="/mytemp/assets/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
    <!-- Bootstrap core CSS-->
    ...
    <!-- Sidebar CSS-->
    <link href="/mytemp/assets/css/sidebar-menu.css" rel="stylesheet" />
    <!-- Custom Style-->
...
<body class="bg-theme bg-theme10">
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
            <div class="brand-logo">
                <a href="index.html">
                    <img src="/mytemp/assets/images/logo-icon.png" class="logo-icon" alt="logo icon">
            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li>
                    <a href="form">
                        <i class="zmdi zmdi-format-list-bulleted"></i> <span>Grafik Penjualan</span>
                    </a>
                </li>
                <li>
                    <a href="/sales-report">
    ...
    <!-- simplebar js -->
    <script src="/mytemp/assets/plugins/simplebar/js/simplebar.js"></script>
    <!-- sidebar-menu js -->
    <script src="/mytemp/assets/js/sidebar-menu.js"></script>
    <!-- loader scripts -->
    <script src="/mytemp/assets/js/jquery.loading-indicator.js"></script>
    <!-- Custom scripts -->
    <script src="/mytemp/assets/js/app-script.js"></script>
    <!-- Chart js -->

    <script src="/mytemp/assets/plugins/Chart.js/Chart.min.js"></script>

    <!-- Index js -->
    <script src="/mytemp/assets/js/index.js"></script>
